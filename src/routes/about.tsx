...
const title = `About ${site.name} — Creator & Podcaster`;
const description =
  "The story behind Ramjan Ali Emon: seven years of content, The Ramjan Show podcast and the Boi Brikkho reading movement in Dhaka, Bangladesh.";
  ...
  return (
    <>
      <section className="relative overflow-hidden pt-36 pb-12 md:pt-44 md:pb-16">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center md:text-left">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg lg:mx-0">
            Switch to বাংলা in the navigation to read this page in Bengali.
          </p>
        </div>
      </section>
      ...
      <SectionShell
        ...
        title={
          <>
            The <span className="font-signature text-gradient">Numbers</span>
          </>
        }
      >
